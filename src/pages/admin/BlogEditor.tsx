...
import { BlogSidebar } from '@/components/admin/BlogEditor/BlogSidebar'
import { RichTextToolbar } from '@/components/admin/BlogEditor/RichTextToolbar'
      ...
      <form onSubmit={handleSave}>
        ...
        <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <BlogSidebar 
            ...
            clearThumbnail={() => { setThumbnailPreview(''); setThumbnail('') }}
