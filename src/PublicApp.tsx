...
function PublicApp() {
  ...
  return (
    <div className="min-h-screen bg-[#120b08] text-white selection:bg-[#e8720c]/20">
      {/* ── HERO SECTION ── */}
      <header className="relative w-full bg-[#120b08] border-b border-white/5 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16 grid gap-10 lg:grid-cols-[1.15fr_0.85fr] items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-[2.5rem] sm:text-5xl lg:text-[4.5rem] font-bold text-white leading-[1.1] tracking-tight uppercase">
                Hơn Cả Thẩm Mỹ<br />
                Đó Là <span className="text-[#e8720c]">Sự Bền Vững</span>
              </h1>
              <p className="w-fit text-[8px] xs:text-[9.5px] sm:text-xs md:text-sm lg:text-base text-white/90 leading-relaxed font-semibold tracking-wide uppercase whitespace-nowrap">
                Thảm Sàn Xanh Cho Không Gian Bền Vững: Bước Đi Chiến Lược Từ Minh Đức Và Carpets Inter
              </p>
              <p className="max-w-2xl text-lg sm:text-xl text-white/80 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="#tai-lieu"
                className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/5 px-6 py-3 text-sm text-white transition duration-200 hover:bg-black/10"
              >
                Tài liệu nổi bật
                <BookOpen size={16} />
              </a>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={label} className="rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 shadow-sm">
                  <div className="text-2xl font-light text-[#e8720c]">{value}</div>
                  <div className="mt-1 text-sm leading-6 text-white/65">{label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-[28px] border border-white/10 bg-[#1a1a1a] p-4 shadow-md">
              ...
              <div className="mt-4 space-y-3 px-1 pb-1">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-light text-white">{heroCollection.name}</h2>
                  </div>
                  <div
                ...
                <p className="text-sm leading-7 text-white/70">{heroCollection.tagline}</p>
      ...
      <section id="collections" className="w-full bg-[#1a1a1a] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[260px_minmax(0,1fr)] items-stretch">
            ...
            {/* SIDEBAR */}
            <div className="relative h-full flex flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#f5f3f0] shadow-sm">
              <div className="shrink-0 border-b border-white/5 p-5">
                ...
                <label className="relative block">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#1a1a1a] py-2.5 pl-10 pr-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#e8720c]/50"
                  />
                </label>
              </div>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full rounded-[18px] border p-3.5 text-left transition-all duration-200 ${
                            active
                              ? 'border-[#e8720c]/30 bg-[#1a1a1a] shadow-[0_8px_24px_rgba(0,0,0,0.03)]'
                              : 'border-transparent hover:border-white/5 hover:bg-[#1a1a1a]/40'
                          }`}
                        >
                          <div className="flex items-center justify-between gap-2">
                            <div className="min-w-0 flex-1">
                              <div className={`text-sm font-medium leading-tight ${active ? 'text-[#e8720c]' : 'text-white'}`}>
                                {item.name}
                              </div>
                              <div className="mt-1 line-clamp-1 text-[11px] leading-4 text-white/50">
                                {item.tagline}
                              </div>
                            </div>
                            {active && (
              ...
              <div className="shrink-0 mt-auto border-t border-white/5 px-4 py-3 bg-[#e5e3de]">
                <div className="text-center text-[10px] uppercase tracking-[0.2em] text-white/40 font-semibold font-sans">
            ...
            {/* PRODUCT DETAIL VIEW */}
            <div id={`collection-${activeCollection.id}`} className="overflow-hidden rounded-[30px] border border-white/10 bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-5 lg:p-7">
              <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
                {/* Left pane */}
                <div className="space-y-5">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="rounded-full border border-white/10 bg-[#f5f3f0] px-3 py-1 text-xs uppercase tracking-[0.2em] text-[#e8720c] font-semibold">
                      Chi tiết sản phẩm
                    </span>
                    <span className="rounded-full bg-black/5 px-3 py-1 text-xs text-white/60 font-medium">
                  ...
                  <p className="text-sm leading-8 text-white/80">{activeCollection.summary}</p>
                  <p className="text-sm leading-8 text-white/60">{activeCollection.detail}</p>

                  <div className="grid gap-3 sm:grid-cols-3">
                    {activeCollection.quickFacts.map((fact) => (
                      <div key={fact} className="rounded-2xl border border-black/6 bg-[#f5f3f0] p-4 text-sm leading-6 text-white/75 shadow-sm">
                        {fact}
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-4">
                  <div className="overflow-hidden rounded-[22px] border border-white/10 bg-[#120b08]">
                    <AnimatePresence mode="wait">
                      <motion.img
                        key={currentSlide}
                  ...
                  <div className="grid grid-cols-3 gap-2.5 sm:grid-cols-4">
                    {productShowcase.slice(0, 8).map((image, index) => (
                      <button
                        ...
                        className={`overflow-hidden rounded-xl border bg-[#f5f3f0] transition-all duration-200 ${image === currentSlide ? 'border-[#e8720c] ring-2 ring-[#e8720c]/10' : 'border-white/10 hover:border-black/25'}`}
                      >
      ...
      {/* ── NEWS SECTION ── */}
      <section id="news" className="w-full bg-[#f5f3f0] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[260px_minmax(0,1fr)] items-stretch">
            {/* SIDEBAR NEWS */}
            <div className="relative h-full flex flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#1a1a1a] shadow-sm">
                    ...
                    {newsArticles.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full rounded-[18px] border p-3.5 text-left transition-all duration-200 ${
                            active
                              ? 'border-[#e8720c]/30 bg-[#120b08] shadow-[0_4px_16px_rgba(0,0,0,0.02)]'
                              : 'border-transparent hover:border-white/5 hover:bg-black/5'
                          }`}
                        >
                          <div className="flex flex-col gap-1.5">
                            <div className={`text-sm font-medium leading-tight line-clamp-2 ${active ? 'text-[#e8720c]' : 'text-white'}`}>
                              {item.title}
                            </div>
            ...
            {/* DETAIL NEWS VIEW */}
            <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-5 lg:p-7">
              <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
                <div className="space-y-5">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="flex items-center gap-1 rounded-full bg-black/5 px-3 py-1 text-xs text-white/60 font-medium">
                  ...
                  <div className="space-y-4 text-sm leading-8 text-white/75">
                ...
                <div className="space-y-4 h-full flex flex-col">
                  <div className="overflow-hidden rounded-[22px] border border-white/10 bg-[#120b08] flex-1 min-h-[300px]">
                    <AnimatePresence mode="wait">
                      <motion.img
                        key={activeNews.id}
                        initial={{ opacity: 0.35, scale: 1.03 }}
      ...
      <section className="w-full bg-[#1a1a1a] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-2">
          {/* GIÁ TRỊ NỔI BẬT */}
          <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-6 lg:p-8 space-y-6">
            ...
            <div className="space-y-3">
              {activeCollection.valuePoints.map((item) => (
                <div key={item} className="flex items-start gap-3 rounded-2xl border border-black/6 bg-[#120b08] p-4 transition-all duration-200 hover:bg-[#1a1a1a] hover:shadow-sm">
          ...
          {/* THÔNG SỐ KỸ THUẬT */}
          <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-6 lg:p-8">
            {selectedProduct ? (
              <>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  {activeCollection.applications.length > 0 && (
                    <div className="rounded-2xl border border-black/6 bg-[#f5f3f0] px-4 py-3 sm:col-span-2">
                      ...
                      <div className="mt-1 text-sm leading-6 text-white/80">{activeCollection.applications.join(' · ')}</div>
                    </div>
                  )}
                    ...
                    <div className="rounded-2xl border border-black/6 bg-[#f5f3f0] px-4 py-3 sm:col-span-2">
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {selectedProduct.colors.map((c) => (
                          <span key={c} className="rounded-full border border-white/10 bg-[#1a1a1a] px-3 py-1 text-xs text-white/70 font-medium">{c}</span>
                        ))}
                      </div>
                    </div>
                  ) : null}
      ...
      <section className="w-full bg-[#120b08] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="rounded-[30px] border border-white/10 bg-[#1a1a1a] shadow-[0_8px_30px_rgba(0,0,0,0.02)] p-5 lg:p-7 space-y-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="text-xs text-white/40 font-medium">Click vào sản phẩm để xem chi tiết</div>
            </div>
      ...
      {/* ── BROCHURES & DOCUMENTS ── */}
      <section id="tai-lieu" className="w-full bg-[#f5f3f0] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex items-center gap-2 text-sm uppercase tracking-[0.22em] text-[#e8720c] font-semibold">
            <FileText size={16} />
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {activeCollection.resources.map((resource) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 shadow-sm transition-all duration-200 hover:border-[#e8720c]/40 hover:shadow-md hover:bg-[#120b08]"
              >
                <div>
      ...
      <section className="w-full bg-[#1a1a1a] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          {/* Photos Grid */}
          <div className="rounded-[30px] border border-white/10 bg-[#120b08] p-5 md:p-6 space-y-5">
            <div className="flex items-center gap-2 text-sm uppercase tracking-[0.22em] text-[#e8720c] font-semibold">
              <Sparkles size={16} />
            ...
            <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
              {collectionGallery.map((image, index) => (
                <button
                  ...
                  className="group overflow-hidden rounded-[22px] border border-white/10 bg-[#1a1a1a] text-left shadow-sm animate-fade-in"
                >
                  ...
                  <div className="px-4 py-3 text-sm text-white/75 font-medium">Hình ảnh bộ sưu tập #{index + 1}</div>
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {collections.map((item) => (
                <a
                  ...
                  className="overflow-hidden rounded-[26px] border border-white/10 bg-[#1a1a1a] shadow-sm transition-all duration-300 hover:border-[#e8720c]/40 hover:shadow-md group"
                >
                  ...
                  <div className="space-y-3 p-4">
                    ...
                    <p className="line-clamp-3 text-sm leading-6 text-white/60">{item.summary}</p>
      ...
      {/* ── PORTFOLIO RESOURCES ── */}
      <section className="w-full bg-[#f5f3f0] py-16 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-6 lg:grid-cols-[1fr_1.1fr]">
          <div className="rounded-[30px] border border-white/10 bg-[#1a1a1a] p-6 shadow-sm space-y-4">
            <div className="text-sm uppercase tracking-[0.22em] text-[#e8720c] font-semibold">Tài liệu tổng hợp</div>
            <h3 className="text-2xl font-light text-white sm:text-3xl">Portfolio hỗ trợ khách hàng</h3>
          ...
          <div className="grid gap-3">
            {featuredResources.map((resource) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between gap-3 rounded-[24px] border border-white/10 bg-[#1a1a1a] p-5 shadow-sm transition-all duration-200 hover:border-[#e8720c]/40 hover:shadow-md hover:bg-[#120b08]"
              >
                <div>
                  <div className="text-base font-medium text-white">{resource.label}</div>
      ...
      <footer id="lien-he-nhanh" className="relative w-full bg-[#1a1a1a] text-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          ...
          {/* Info Side */}
          <div className="rounded-[30px] border border-white/10 bg-[#1a1a1a]/5 p-6 backdrop-blur-md space-y-6">
            <div>
            ...
            <div className="space-y-4 text-sm text-white/80">
              ...
              <div className="rounded-2xl border border-white/10 bg-[#1a1a1a]/6 p-4">
          ...
          <div className="space-y-6">
            <div className="rounded-[30px] border border-white/10 bg-[#1a1a1a]/5 p-6 backdrop-blur-md space-y-6">
              ...
              <form className="grid gap-4 md:grid-cols-2">
                <input value={formData.name} onChange={(e) => handleFormChange('name', e.target.value)} className="rounded-2xl border border-white/12 bg-[#1a1a1a]/8 px-4 py-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#ffd184]" placeholder="Họ và tên" />
                <input value={formData.phone} onChange={(e) => handleFormChange('phone', e.target.value)} className="rounded-2xl border border-white/12 bg-[#1a1a1a]/8 px-4 py-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#ffd184]" placeholder="Số điện thoại" />
                <input value={formData.email} onChange={(e) => handleFormChange('email', e.target.value)} className="rounded-2xl border border-white/12 bg-[#1a1a1a]/8 px-4 py-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#ffd184] md:col-span-2" placeholder="Email / công ty" />
                <input value={formData.project} onChange={(e) => handleFormChange('project', e.target.value)} className="rounded-2xl border border-white/12 bg-[#1a1a1a]/8 px-4 py-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#ffd184] md:col-span-2" placeholder="Dự án quan tâm / bộ sưu tập mong muốn" />
                <textarea value={formData.message} onChange={(e) => handleFormChange('message', e.target.value)} className="min-h-36 rounded-2xl border border-white/12 bg-[#1a1a1a]/8 px-4 py-3 text-sm text-white outline-none placeholder:text-white/40 focus:border-[#ffd184] md:col-span-2" placeholder="Mô tả yêu cầu: diện tích, phong cách, mức độ sang trọng, tiến độ thi công..." />
            ...
            <div className="rounded-[30px] border border-white/10 bg-[#1a1a1a]/5 p-6 backdrop-blur-md space-y-5">
                ...
                {[
                  ...
                  return (
                    <a
                      ...
                      className="flex items-center justify-between rounded-2xl border border-white/10 bg-[#1a1a1a]/6 px-4 py-4 text-sm text-white/80 transition-all duration-200 hover:border-[#ffd184]/50 hover:bg-[#1a1a1a]/10 hover:text-white"
                    >
      ...
      <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-3">
        <a href={`https://wa.me/84${contactInfo.hotline.replace(/^0/, '')}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#1a1a1a]/90 shadow-md backdrop-blur-md px-5 py-3 text-sm text-white transition-all duration-200 hover:border-[#e8720c]/40 hover:bg-[#1a1a1a] font-medium font-sans">
          <MessageCircle size={16} className="text-[#e8720c]" />
          WhatsApp
        </a>
        <a href="https://www.facebook.com/noithatcongcong" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#1a1a1a]/90 shadow-md backdrop-blur-md px-5 py-3 text-sm text-white transition-all duration-200 hover:border-[#e8720c]/40 hover:bg-[#1a1a1a] font-medium font-sans">
          <MessageCircle size={16} className="text-[#e8720c]" />
          Facebook
        </a>
      </div>
        ...
        {selectedModalProduct && (
          ...
          >
            ...
            <motion.div 
              ...
              className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-[32px] border border-white/10 bg-[#1a1a1a] text-white shadow-2xl scrollbar-thin scrollbar-track-transparent scrollbar-thumb-black/10"
            >
              <button 
                onClick={() => setSelectedModalProduct(null)}
                className="absolute right-5 top-5 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/10 text-white/70 hover:bg-black/20 hover:text-white backdrop-blur-md transition cursor-pointer font-bold"
              >
                ✕
              </button>

              <div className="grid md:grid-cols-[1fr_1fr] h-full min-h-[500px]">
                <div className="bg-[#f5f3f0] h-64 md:h-auto border-r border-white/5 flex items-center justify-center">
                   {selectedModalProduct.image ? (
                     ...
                     <div className="text-white/35 font-sans">Chưa có hình ảnh</div>
                   )}
                </div>
                <div className="p-8 md:p-10 space-y-6">
                   ...
                   <div className="space-y-4 rounded-[24px] border border-white/10 bg-[#f5f3f0] p-6 shadow-inner">
                     <div className="text-xs uppercase tracking-[0.22em] text-[#e8720c] font-semibold">Thông số kỹ thuật chi tiết</div>
                     <div className="grid gap-3 text-sm leading-7 text-white/80 font-sans">
                     ...
                     <div className="pt-4 border-t border-white/5">
                       ...
                       <div className="mt-2 flex gap-2 flex-wrap">
                         {selectedModalProduct.colors.map(color => (
                            <span key={color} className="rounded-full bg-[#f5f3f0] border border-white/5 px-3 py-1 text-sm text-white/80 font-medium font-sans">{color}</span>
                         ))}
                       </div>
                     </div>
                   ) : null}
...
function ProductCard({ product, accent, onClick }: { product: Product; accent: string; onClick?: () => void }) {
  ...
  return (
    <Component 
      ...
      onClick={onClick} 
      className={`group flex h-full flex-col overflow-hidden rounded-[24px] border border-white/10 bg-[#1a1a1a] text-left shadow-sm transition duration-300 hover:border-[#e8720c]/40 hover:shadow-md ${onClick ? 'cursor-pointer' : ''}`}
    >
      {product.image && (
         <div className="h-40 w-full shrink-0 overflow-hidden bg-[#f5f3f0] border-b border-white/5">
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-xs uppercase tracking-[0.22em] text-white/40 font-semibold">{product.code}</div>
