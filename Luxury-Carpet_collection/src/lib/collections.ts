...
export const collectionHeroRotator = [
  {
    id: 'foundation',
    name: 'Foundation',
    image: 'https://carpetsinter.com/wp-content/uploads/2025/09/IMG_6573-scaled.jpg',
    accent: '#f2a94b',
  ...
  },
  {
    id: 'groundwork',
    name: 'Groundwork',
    image: 'https://carpetsinter.com/wp-content/uploads/2025/04/shutterstock_578214211-crop-scaled.jpg',
    accent: '#f3a746',
  ...
  },
  {
    id: 'ebb-retreat',
    name: 'EBB Retreat',
    image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR04-42-Herringbone-roomscene-1.jpg',
    accent: '#e0a04e',
  ...
  },
  {
    id: 'discover',
    name: 'Discover',
    image: 'https://carpetsinter.com/wp-content/uploads/2023/05/DV200_202-e1684310233612.jpg',
    accent: '#ffb049',
  ...
  },
  {
    id: 'aspekt-vue',
    name: 'Aspekt: Vue',
    image: 'https://carpetsinter.com/wp-content/uploads/2024/10/Vue-e1728381708911.jpg',
    accent: '#ffc169',
...
export const collections: CollectionItem[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      'https://carpetsinter.com/wp-content/uploads/2024/10/Insight-3-e1730193562648.jpg',
    ...
    products: [
      ...
      { code: 'AKI05', name: 'Reveal', highlights: ['Bề mặt giàu chất liệu', 'Tăng cảm giác đầu tư chỉn chu'], image: 'https://carpetsinter.com/wp-content/uploads/2024/10/05.jpg', spec: { ...commonSpecs, pile: 'Textured tonal loop', useCase: 'Corporate workspace / executive area' } },
      { code: 'AKI06', name: 'Focus', highlights: ['Tạo nền trung tính cao cấp', 'Hỗ trợ nội thất nổi bật hơn'], image: 'https://carpetsinter.com/wp-content/uploads/2024/10/06.jpg', spec: { ...commonSpecs, pile: 'Dense loop construction', useCase: 'Workspace / support area' } },
      { code: 'AKI07', name: 'Trace', highlights: ['Giữ nhịp thị giác tinh tế', 'Phù hợp thiết kế tối giản có chiều sâu'], image: 'https://carpetsinter.com/wp-content/uploads/2024/10/07.jpg', spec: { ...commonSpecs, pile: 'Directional loop surface', useCase: 'Circulation / planning zone' } },
      { code: 'AKI08', name: 'Empower', highlights: ['Điểm nhấn mạnh hơn', 'Tăng cá tính cho khu vực trưng bày'], image: 'https://carpetsinter.com/wp-content/uploads/2024/10/AKI08.jpg', spec: { ...commonSpecs, pile: 'Bold directional loop', useCase: 'Showroom / statement path' } },
      { code: 'AKI09', name: 'Depth', highlights: ['Kết thúc bảng màu bằng chiều sâu mạnh', 'Thể hiện bản sắc thiết kế rõ ràng'], image: 'https://carpetsinter.com/wp-content/uploads/2024/10/09.jpg', spec: { ...commonSpecs, pile: 'Expressive premium loop', useCase: 'Feature flooring / sales gallery' } },
    ],
    resources: [
  ...
  },
  {
    ...
    gallery: [
      ...
      'https://carpetsinter.com/wp-content/uploads/2025/10/waterloo.jpg',
      'https://carpetsinter.com/wp-content/uploads/2025/10/Web-2.jpg',
    ],
    accent: '#f0ac48',
    ...
    products: [
      { code: 'WL201', name: 'Waterloo 201', highlights: ['Tạo nền sắc sảo', 'Dễ kết hợp vật liệu kim loại và gỗ tối'], image: 'https://carpetsinter.com/wp-content/uploads/2025/11/WL201.jpg', spec: { ...commonSpecs, pile: 'Urban directional loop', useCase: 'Corporate reception / lounge' } },
      { code: 'WL202', name: 'Waterloo 202', highlights: ['Đem lại cảm giác sáng rõ hơn', 'Phù hợp khu vực tiếp xúc cao'], image: 'https://carpetsinter.com/wp-content/uploads/2025/10/WL202.jpg', spec: { ...commonSpecs, pile: 'Fine commercial loop', useCase: 'High traffic business area' } },
      ...
      { code: 'WL204', name: 'Waterloo 204', highlights: ['Mạnh mẽ, cao cấp', 'Phù hợp làm lựa chọn chủ đạo'], image: 'https://carpetsinter.com/wp-content/uploads/2025/10/WL204.jpg', spec: { ...commonSpecs, pile: 'Dense directional loop', useCase: 'Main flooring concept' } },
      { code: 'WL205', name: 'Waterloo 205', highlights: ['Tinh chỉnh ánh sáng nền', 'Tạo trải nghiệm cao cấp trực tiếp'], image: 'https://carpetsinter.com/wp-content/uploads/2025/10/WL205.jpg', spec: { ...commonSpecs, pile: 'Refined tonal loop', useCase: 'Premium workspace / boardroom' } },
      ...
      { code: 'WL207', name: 'Waterloo 207', highlights: ['Biến thể sắc độ mạnh hơn', 'Tăng hiệu ứng chuyển tiếp cho layout đô thị'], image: 'https://carpetsinter.com/wp-content/uploads/2025/11/WL201-ADJUST-COLOR.jpg', spec: { ...commonSpecs, pile: 'Accent tonal loop', useCase: 'Transition / feature insert' } },
      { code: 'WL208', name: 'Waterloo 208', highlights: ['Tăng chiều sâu hình khối', 'Phù hợp khu vực cần nhấn chuyển động'], image: 'https://carpetsinter.com/wp-content/uploads/2025/10/WL204-1.jpg', spec: { ...commonSpecs, pile: 'Structured accent loop', useCase: 'Architectural highlight flooring' } },
      { code: 'WL209', name: 'Waterloo 209', highlights: ['Kết thúc bảng mã với sắc độ giàu tương phản', 'Phù hợp phân khu thẩm mỹ cao cấp'], image: 'https://carpetsinter.com/wp-content/uploads/2025/10/WL205-1.jpg', spec: { ...commonSpecs, pile: 'Premium contrast loop', useCase: 'Premium zoning / statement floor' } },
    ],
    resources: [
  ...
  },
  {
    ...
    gallery: [
      ...
      'https://carpetsinter.com/wp-content/uploads/2025/12/EBR41-Loch-Sky.jpg',
      'https://carpetsinter.com/wp-content/uploads/2025/12/EBR42-Loch-Bottle.jpg',
      'https://carpetsinter.com/wp-content/uploads/2025/12/EBR43-Loch-Limestone.jpg',
      'https://carpetsinter.com/wp-content/uploads/2025/12/EBR44-Loch-Dusk.jpg',
    ],
    accent: '#e0a04e',
    ...
    products: [
      { code: 'EBR01', name: 'Brook', highlights: ['Êm dịu và cân bằng', 'Phù hợp khu vực đón tiếp sang trọng'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR01-Brook-1.jpg', spec: { ...commonSpecs, pile: 'Soft tonal loop', useCase: 'Hospitality lounge / quiet reception' } },
      { code: 'EBR02', name: 'Billabong', highlights: ['Hiệu ứng mềm', 'Tạo cảm giác nghỉ dưỡng tinh tế'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR02-Billabong-1.jpg', spec: { ...commonSpecs, pile: 'Organic tonal loop', useCase: 'Resort office / waiting area' } },
      { code: 'EBR03', name: 'Mangrove', highlights: ['Chuyển động tự nhiên', 'Cho mặt sàn chiều sâu giàu cảm xúc'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR03-Mangrove-1.jpg', spec: { ...commonSpecs, pile: 'Flow-inspired loop', useCase: 'Feature lounge / hospitality path' } },
      { code: 'EBR04', name: 'Loch', highlights: ['Tăng độ ấm và chiều sâu', 'Phù hợp không gian hospitality'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR04-Loch-1.jpg', spec: { ...commonSpecs, pile: 'Deep tonal loop', useCase: 'Premium retreat setting' } },
      { code: 'EBR05', name: 'Reef', highlights: ['Tạo cá tính nhẹ nhàng', 'Làm giàu trải nghiệm thị giác'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR05-Reef-1.jpg', spec: { ...commonSpecs, pile: 'Textured low loop', useCase: 'Soft feature zone' } },
      { code: 'EBR06', name: 'Inlet', highlights: ['Mở rộng bảng sắc độ', 'Tăng lựa chọn hài hòa cho không gian nghỉ dưỡng'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR06-Inlet.jpg', spec: { ...commonSpecs, pile: 'Subtle tonal loop', useCase: 'Quiet retreat / lounge setting' } },
      { code: 'EBR21', name: 'Retreat 21', highlights: ['Màu sắc dịu', 'Phù hợp không gian nghỉ và tiếp khách'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR21.png', spec: { ...commonSpecs, pile: 'Monotone commercial loop', useCase: 'Quiet room / relaxation corner' } },
      { code: 'EBR22', name: 'Retreat 22', highlights: ['Tinh chỉnh chiều sâu ánh sáng', 'Mang lại sự ấm áp tinh tế'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR22.png', spec: { ...commonSpecs, pile: 'Warm tonal loop', useCase: 'Hospitality interior / soft seating' } },
      { code: 'EBR31', name: 'Flow 31', highlights: ['Nhịp bề mặt tự nhiên', 'Tăng cảm giác sang trọng mềm'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR31.png', spec: { ...commonSpecs, pile: 'Directional natural loop', useCase: 'Flow path / brand hospitality' } },
      { code: 'EBR32', name: 'Flow 32', highlights: ['Nhịp chuyển động rõ hơn', 'Phù hợp phân vùng mềm giữa các không gian'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR32.png', spec: { ...commonSpecs, pile: 'Flow pattern loop', useCase: 'Integrated hospitality layout' } },
      { code: 'EBR41', name: 'Loch Sky', highlights: ['Tông sáng, thoáng hơn', 'Tăng cảm giác mở cho không gian cao cấp'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR41-Loch-Sky.jpg', spec: { ...commonSpecs, pile: 'Light tonal loop', useCase: 'Open lounge / reception' } },
      { code: 'EBR42', name: 'Loch Bottle', highlights: ['Chiều sâu đậm hơn', 'Tạo cảm giác sang trọng có trọng lượng'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR42-Loch-Bottle.jpg', spec: { ...commonSpecs, pile: 'Deep accent loop', useCase: 'Feature lounge / executive hospitality' } },
      { code: 'EBR43', name: 'Loch Limestone', highlights: ['Cân bằng sắc độ nhẹ', 'Dễ phối với nội thất sáng màu hiện đại'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR43-Loch-Limestone.jpg', spec: { ...commonSpecs, pile: 'Balanced tonal loop', useCase: 'Refined retreat setting' } },
      { code: 'EBR44', name: 'Loch Dusk', highlights: ['Tông dusk trầm ấm', 'Gia tăng cảm xúc thư giãn về cuối ngày'], image: 'https://carpetsinter.com/wp-content/uploads/2025/12/EBR44-Loch-Dusk.jpg', spec: { ...commonSpecs, pile: 'Warm dusk loop', useCase: 'Premium retreat / hospitality suite' } },
    ],
    resources: [
